            ...
            do
            {
                ...
                switch(choice)
                {
                    case 1:
                        ...
                        manager.CreateCourse(new Course(courseId, title, duration, price));
                    ...
                    case 2:
                        ...
                        foreach (var course in manager.ReadCourses())
                        {
                    ...
                    case 3:
                        ...
                        var existingCourse = manager.GetCourseById(updateId);
